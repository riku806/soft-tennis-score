...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference("Point.count") do
      post points_url, params: { point: { game_id: @point.game_id, kind: @point.kind, winner: @point.winner } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { game_id: @point.game_id, kind: @point.kind, winner: @point.winner } }
